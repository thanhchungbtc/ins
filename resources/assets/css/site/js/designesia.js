    ...
    jQuery("#mainmenu > li > span").on( "click", function() {
        ...
        switch (iteration) {
            case 1:
				...
				var curHeight = $(this).parent().find("ul").height();
				$(this).parent().find("ul").css("height","0");
				$(this).parent().find("ul").animate({'height': curHeight},400,'easeInOutQuint');
				
				break;

            case 2:
				$(this).removeClass("active");
                $(this).parent().find("ul").animate({'height': "0"},400,'easeInOutQuint');
				break;
        }
        iteration++;
